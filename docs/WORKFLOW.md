...
| `factory/power.rs` | `GENERATOR_POWER`, `CONSTRUCTOR_POWER`, `ROUTER_POWER` | 60 kW (burns coal 8 s, log 4 s), 15 kW while working, 1 kW while holding an item |
| `factory/power.rs` | `WIRE_RANGE`, `POLE_REACH` | poles link within 10 blocks, machines hang on the nearest pole within 5 |
| `factory/mod.rs` | `MACHINES` slots | miner 1 stack (64 ore), box 24, smelter and constructor 1 per buffer, generator 1 fuel stack |
